...
def runTracking(imageName, segmentationOPFolder, trackingOPFolder, startTime, endTime, trackbackTime, min_obj_size, protein1Name, protein2Name):
    prepare(imageName, protein1Name, protein2Name)
    trackStep1(segmentationOPFolder,trackingOPFolder,startTime,endTime)
    trackStep2(track_op_folder=trackingOPFolder, trackbackT=trackbackTime, startpoint=startTime, endpoint=endTime, protein1Name=protein1Name, protein2Name=protein2Name, imageName=imageName)
